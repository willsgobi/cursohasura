...
mixin _$AddProdutoController on _AddProdutoControllerBase, Store {
  ...
  String toString() {
    final string =
        'descricao: ${descricao.toString()},selectedCategoria: ${selectedCategoria.toString()},selectedTipo: ${selectedTipo.toString()},valor: ${valor.toString()},tipoProduto: ${tipoProduto.toString()}';
    return '{$string}';
  }
}
